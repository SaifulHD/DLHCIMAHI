                ...
                <div class="row">
                    <div class="cardsungaimutu">
                        <div class="card-bodysungai">
                            <select disabled id="list" name="list" class="form-select form-select-lg mb-3" aria-label=".form-select-lg example" onclick="getSelectValue()">
                            ...
                            <form action="/Mutuair/update/<?= $Pantau['id_tikpan']; ?>" method="post">
                                <div class="cardtitikpantau">
                                    <div class="card-bodytitik">
                                        ...
                                        <input value="<?= $Pantau['Nama_sungai'] ?>" class="form-control" id="collist" readonly name="collist">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-4">
                                        <input value="<?= $Pantau['Param_2'] ?>" type="number" class="form-control" id="coldo" name="coldo">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="inputNumber" class="col-sm-2 col-form-label">BOD(m3/s)</label>
                                    <div class="col-sm-4">
                                        <input value="<?= $Pantau['Param_3'] ?>" type="number" class="form-control" id="colbod" name="colbod">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="inputNumber" class="col-sm-2 col-form-label">COD(m3/s)</label>
                                    <div class="col-sm-4">
                                        <input value="<?= $Pantau['Param_4'] ?>" type="number" class="form-control" id="colcod" name="colcod">
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-4">
                                        <input value="<?= $Pantau['Param_5'] ?>" type="number" step="any" class="form-control" id="colfosfat" name="colfosfat">
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    <label for="inputNumber" class="col-sm-2 col-form-label">Total
                                        Coliform(m3/s)</label>
                                    <div class="col-sm-4">
                                        <input value="<?= $Pantau['Param_7'] ?>" type="number" class="form-control" id="colcoliform" name="colcoliform">
                                    </div>
                                </div>
